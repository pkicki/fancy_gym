...
from .mujoco.box_pushing.box_pushing_constr_env import BoxPushingConstrDense, BoxPushingConstrDensePDFF
...
for reward_type in ["ConstrDense", "ConstrDensePDFF", "Dense", "TemporalSparse", "TemporalSpatialSparse"]:
    register(
